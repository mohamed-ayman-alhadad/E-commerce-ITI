  ...
  return (
    <div>
      {Cartproducts.length === 0 ? (
        <div className="flex justify-center items-center w-100 h-90 my-auto">
          <img src={isEmpty} className="w-35 px-4" />
        ...
        <div className="container ">
          ...
          <div className="flex justify-between mt-5">
            <div className="flex w-50 h-15 gap-3 ">
              ...
              />
              <button className="border bg-red-600 rounded border-gray-300 text-white hover:bg-red-400 focus:ring-4 focus:outline-none focus:ring-red-200  text-sm px-5 py-2.5 text-center">
                Apply Coupon
              </button>
            </div>
            <div className=" w-50 h-80 rounded-lg border-1 p-4 ">
              ...
              <div className="flex justify-center">
                <button onClick={() => navigation("/checkout")} className="border mt-4  bg-red-600 rounded border-gray-300 text-white hover:bg-red-400 focus:ring-4 focus:outline-none focus:ring-red-200  text-sm px-5 py-2.5 text-center">
                  Checkout
                </button>
              </div>
            </div>
