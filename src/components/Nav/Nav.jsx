    ...
    <>
      <nav className="d-flex w-100 container justify-content-between align-items-center ">
        ...
        <ul
          className={
            show
              ? "d-flex flex-column position-absolute rounded right-15 top-30  w-30 bg-gradient-to-r from-blue-300 to-white  z-10 h-55 list-unstyled  align-items-center gap-3  mb-0 d-lg-none"
              : "d-flex list-unstyled  align-items-center gap-5 h-100 mb-0 d-none d-lg-flex"
          }
        >
          {routes.map((route) => (
        ...
        <div className="d-flex align-items-center ">
          <div className="input-group  mx-3">
            ...
            <div className="input-group-prepend">
              <span className="input-group-text w-100 h-100 px-3" id="basic-addon1">
